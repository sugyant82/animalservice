...
public class Shark implements Fishes{
	
	private String type="FISH";
	private String name="SHARK";
	
	private String size = "I am large";
	private String color= "I am grey colored";
	private String eat = "I eat other fishes";
	private String makeJokes = "I dont like to make jokes";
